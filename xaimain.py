...
# Constants
SEVERITY_LABELS = ["Mild", "Moderate", "Proliferate_DR", "No_DR", "Severe"]
DAMAGE_CLASSES = {"Mild", "Moderate", "Proliferate_DR", "Severe"}
REMEDIES = {
...
# Dummy Torch Model (replace with your actual architecture)
...
# Matplotlib Canvas for Severity Graph
...
class DiabetesApp(QWidget):
    ...
    def load_models(self):
        ...
        try:
            ...
            print(f"[ERROR] TensorFlow model: {e}")
    ...
    def initUI(self):
        ...
        self.button.setStyleSheet("background-color: white; color: black; font-size: 14px; font-weight: bold; padding: 5px; border-radius: 5px;")
    ...
    def upload_image(self):
        ...
        if file_name:
            ...
            self.remedy_label.setText(f"Remedy: {REMEDIES.get(predicted_label, 'Consult your doctor.')}")
    ...
    def predict_with_model(self, image_path):
        ...
        if len(prediction) != len(SEVERITY_LABELS):
            return "Invalid model output!", None
